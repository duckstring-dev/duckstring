...
Status: **built** — Phase 1 (identity), Phase 2 (recursive view backend), Phase 3 (UI lineage
overlay). Builds on cross-catchment-ducts.md. Goal: every Pond's **entire** upstream lineage is
